...
const Riders = () => {
          ...
          return (
            <Row>
              <Col breakPoint={{ xs: 12, lg: 6 }}>
                <Link href={`rider/form/${riderList[tableMeta.rowIndex].id}`}>
                  ...
                  onClick={() =>
                    Swal.fire({
                      ...
                      if (result.isConfirmed) {
                        deleteRider(riderList[tableMeta.rowIndex].id!);
                      }
  ...
  return (
    <Layout title="Riders">
      ...
      {!isLoading && <MUIDataTable title={'Daftar Pengendara'} data={riderList} columns={columns} options={options} />}
    </Layout>
  );
};
